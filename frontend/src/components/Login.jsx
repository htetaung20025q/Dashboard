...
export default function Login({ onLoginSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 3. Callback to app.jsx to update global auth status
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 shadow-xl shadow-slate-100 sm:rounded-3xl border border-slate-100 sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {error && (
              <div className="flex items-start gap-2.5 p-3.5 bg-rose-50 border border-rose-100 text-rose-700 text-sm rounded-xl animate-shake">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. admin or alice.smith"
                />
              </div>
            </div>
